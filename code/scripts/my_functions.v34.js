...
3. In the lhs, if we face an NAC node, then it ends there. Not checking for further NAC nodes. In other words, the NAC chain length is always assumed to be 1.
4. The 0th node of lhs is always a regular node, not an NAC or a new node or a node to be deleted or an anonymous node.
