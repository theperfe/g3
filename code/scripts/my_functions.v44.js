...
//  return filter_matches_with_negative_edges(graph1, graph2, matches_list); //not necessary right now
  return remove_duplicate_matches_specific_to_NVFO(graph1, graph2, matches_list);
}
...
//	    console.log(JSON.stringify(representative_nodes_list_typewise[p]));
//	    console.log(JSON.stringify(predecessors(graph1, representative_nodes_list_typewise[p], graph1.link_types[q])));
//	    console.log(JSON.stringify(predecessors(graph2, mega_perms[i][p], graph1.link_types[q])));
//  	    console.log(JSON.stringify(representative_nodes_list_typewise[p]));
...
//	    console.log(JSON.stringify(successors(graph2, mega_perms[i][p], graph1.link_types[q])));
       if(result1 && result2){
...
//  console.log(JSON.stringify(matches_list));
  var lhs_source_node_key = null, lhs_target_node_key = null, match_source_node_key = null, match_target_node_key = null, mg_source_node = null, mg_target_node = null, temp_successors = [];
  var negative_edges = graph1.links.filter(function(element){return (element.marker_id[0] == '!' || element.definition.slice(0,5) == 'new::');});
