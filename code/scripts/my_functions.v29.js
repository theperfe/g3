...
*/
  ...
  //to store all the matches of graph1 in graph2 in an array
  ...
  for(var p=0; p<possible_matching_nodes.length; p++){
   ...
   current_node.rule_index = 0;	//rule_index refers to the index of the node in the rule with which this node is matching.
