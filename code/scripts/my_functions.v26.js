...
var inherences = {
  "pred":{"U":[], "A":["U"], "Q":["U"], "Dr":["U", "A", "Q", "Dr"], "US":["U", "A", "Q", "Dr", "V"], "V":[]},
  "succ":{"U":["A", "Q", "Dr", "US"], "A":["Dr", "US"], "Q":["Dr", "US"], "Dr":["Dr", "US"], "US":[], "V":["US"]}
}
...
function extract_all_interpretations(obj){
  var final_arr = [], arr = [];
  obj.child.forEach(function(element){
...
function extract_all_interpretations_recursively(obj){
  ...
  obj.pred.forEach(function(element){
    ...
    pred_arr.forEach(function(local_element){arr.push(local_element);});
  });
  obj.succ.forEach(function(element){
    ...
    succ_arr.forEach(function(local_element){arr.push(local_element);});
  });
...
function cartesian_product(a1, a2){	//each argument is an array of arrays, and the output is one single array of arrays.
  if(a1.length == 1 && a1[0].length == 0) return a2;
  if(a2.length == 1 && a2[0].length == 0) return a1;
  var final_arr = [];
