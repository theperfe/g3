...
function match_final(graph1, graph2){
  var all_matches = null, final_matches = [[]];
  ...
  all_matches = match(graph1, graph2);
  final_matches = extract_all_matches(all_matches);
//  console.log(JSON.stringify(final_matches));
...
//  console.log(JSON.stringify(negative_edges));
  if(negative_edges.length == 0) return final_matches;
  else{
...
//      lhs_source_node_key = negative_edges[i].source.key; 
      ...
      final_matches.forEach(function(element){
...
//	    console.log("entered");
//	    console.log(JSON.stringify(final_matches));
	    final_matches.splice(final_matches.indexOf(element),1);
//	    console.log(JSON.stringify(final_matches));
	  }
	}
      });
